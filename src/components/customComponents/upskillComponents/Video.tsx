    ...
    <div className="max-w-xl mx-auto flex flex-col items-center space-y-4">
      ...
      <div className="text-center">
        <h2 className="text-xl font-medium">
          Become An <span className="text-red-500 font-semibold">Multi-Agent Expert</span> in Hours
        </h2>
      </div>
      ...
      <Card className="w-full overflow-hidden">
        <div className="relative aspect-video bg-gray-200">
          ...
          <div className="absolute top-2 left-2 bg-red-500 text-white text-xs px-2 py-1 rounded">DeepLearning.AI</div>

          {/* Red text in the middle */}
          <div className="absolute top-1/4 left-0 right-0 text-center">
            <div className="text-red-500 font-medium">AI Agent Workflows with crewAI</div>
            <div className="text-sm">João Moura</div>
          </div>

          {/* CrewAI logo */}
          <div className="absolute top-1/3 left-1/2 -translate-x-1/2 flex items-center gap-2">
            <div className="bg-gray-800 text-white text-xs px-2 py-1 rounded">crewAI</div>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-white rounded-full p-2 cursor-pointer">
              <Play className="h-6 w-6 fill-red-500 text-red-500" />
            </div>
          </div>

          {/* Instructor labels */}
          <div className="absolute bottom-0 left-0 right-0 flex justify-between">
            <div className="bg-red-500 text-white p-2 max-w-[180px]">
              <div className="text-sm font-medium">João Moura</div>
              <div className="text-xs">Co-Founder and CEO, CrewAI</div>
            </div>
            <div className="bg-red-500 text-white p-2 max-w-[180px]">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-black/70 text-white text-center py-2 px-4">
            <p className="text-sm">I'm excited to introduce "Multi-AI Agent Systems with crewAI"</p>
          </div>
        </div>
      </Card>

      {/* Button - Outside the card */}
      <Button className="bg-red-500 hover:bg-red-600 text-white rounded-full px-6">Take the Course for Free</Button>
    </div>
  )
}
